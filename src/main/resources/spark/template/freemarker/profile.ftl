...
<div class="main-content col-md-10 ">
    ...
    <form id="paperForm" enctype="multipart/form-data" class="paperForm" style="display: none" action="/submitPaper"
          method="POST">
        ...
        <input type="text" name="contactAuthor" placeholder="Contact Author" readonly="readonly"
